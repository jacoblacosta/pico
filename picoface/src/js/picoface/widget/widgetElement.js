...
export class ScapeWidgetElement extends AbstractWidget {
    ...
    easy_fromBindedToUnmanagedDom() {
        ...
        if (this.binded.live && this.binded.live.isOuterLightSensorDefined) {
            this.unmanaged.$flatSvg.classList.add('outer-light-defined');
        } else {
            this.unmanaged.$flatSvg.classList.remove('outer-light-defined');
        }
    }
    async easy_saveToRestApi() {
        // do nothing
